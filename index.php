                                        ...
                                        <div class="product-item swiper-slide wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                            <div class="product">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="./assets/img/product/27.jpg" alt="product_image">
                                                        <img class="product-secondary" src="./assets/img/product/27-2.jpg" alt="product_image">
                                                    </a>
                                        ...
                                        <div class="product-item swiper-slide">
                                            <div class="product">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product__name">
                                                        <h4><a href="shop.html">Mens Running Shoes</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                        ...
                                        <div class="product-item swiper-slide">
                                            <div class="product">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product__name">
                                                        <h4><a href="shop.html">Fly Sandal For Women</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>

                ...
                <div class="row align-items-center">
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 d-none d-sm-block">
                        <div class="gota_search">
                            <form class="search_form">
                                <button type="button" class="search_action"><i class="fal fa-search d-sm-none d-md-block"></i></button>
                            ...
                            <nav id="mobile-menu">
                                <ul>
                                    ...
                                    <li><a class="d-none d-xl-block" href="index.php">
                                            <img class="pl-50 pr-50" src="./assets/img/logo/logo-1.png" alt="">
                                        </a></li>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4">
                        <div class="gota_cart gotat_cart_1 text-end">
                            <a href="javascript:void(0)" id="openCart"><i class="fal fa-shopping-cart"></i>My Bag<span class="counter bag-counter"> (2)</span></a>
                        </div>
                    </div>
                </div>
            </div>

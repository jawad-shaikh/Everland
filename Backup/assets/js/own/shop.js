                                                ...
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product__name">
                                                        ...
                                                        <div class="pro-price">
                                                            ...
                                                            <button class="p-absoulute pr-2" href="#" onclick="AddToCart(this,${product.id})">add to cart</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product__name">
                                                        ...
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>${price}</p>
                                                            <button class="p-absoulute pr-2" onclick="AddToCart(this,${product.id})">add to cart</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="viewcontent">
                                                        ...
                                                        <div class="list-actions pt-20">
                                                            <div class="viewcontent__action">
                                                                <span><button onclick="AddToCart(this,${product.id})">add to cart</buton></span>

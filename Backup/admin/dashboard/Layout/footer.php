...
<?php
// $sqlCounter = "SELECT * FROM counter WHERE id=1";
  ...
  <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form method="POST" action="includes/counter-modal-backend.php">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle">Counter Update</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date" value="" onload="this.value = new Date().getDate()" class="form-control">
                </div>

                <div class="form-group">
                    <label for="inputAddress">Time</label>
                    <!-- <input type="time" name="time" value="<?php //$rowDate['time'] ?>" class="form-control"> -->
                    <input type="time" name="time" value="" onload="this.value = new Date().getTime()" class="form-control">
                </div>
              
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
              <button type="submit" class="btn btn-primary" name="UpdateCounter">Save changes</button>
          </form>
        </div>
      </div>
    </div>
